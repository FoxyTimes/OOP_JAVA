...
import ru.minesweeper.client.view.gui.screens.ScreenSingleProcess;
...
public class VisualFieldButtonForSingle extends JButton implements ButtonStandartSettings {
    ...
    ScreenSingleProcess parent;

    MouseAdapter flagSetter;
    public VisualFieldButtonForSingle(ScreenSingleProcess parent, BufferedImage flagTexture, BufferedImage bombTexture) {
        super();
        this.parent = parent;
