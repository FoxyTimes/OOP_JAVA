...
import ru.minesweeper.view.gui.screens.GameProcess;
...
public class VisualFieldButton extends JButton implements ButtonStandartSettings {
    ...
    public VisualFieldButton(GameProcess parent, BufferedImage flagTexture, BufferedImage bombTexture) {
        super();
        this.parent = parent;
