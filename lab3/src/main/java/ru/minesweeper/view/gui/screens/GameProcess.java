...
public class GameProcess extends JPanel implements Observer {
    GameView gameView;
    ...
    ArrayList<ArrayList<VisualFieldButton>> buttons;
    ...
    public GameProcess(GameView gameView) {
        super();
    ...
    private void initGlassPane() {
        ...
        VisualMenuButtonTextable restartButton = menuButtonCreator.createButtonText("BACK", this::backToDifficutlyMenu, this, ADAPTIVE_SCALE_MENU_BUTTON_X, ADAPTIVE_SCALE_MENU_BUTTON_Y);
    ...
    public void createSidePanel(JPanel container) {
        ...
        VisualMenuButtonTextable backGameButton = menuButtonCreator.createButtonText("Back", this::backToDifficutlyMenu, this, ADAPTIVE_SCALE_MENU_BUTTON_X, ADAPTIVE_SCALE_MENU_BUTTON_Y);
    ...
    private void backToDifficutlyMenu(TextAnim<VisualMenuButtonTextable> anim, VisualMenuButtonTextable button) {
        ...
        remove(fieldPanel);
        if (!isScreenSwap) {
            gameView.screenSwapToDifficultyMenu(this, Sides.DOWN);
        }
    }
    ...
    public void createEmptyField(DataTransferObject data) {
        ...
        for (int i = 0; i < width; i++) {
            ...
            for (int j = 0; j < height; j++) {
                VisualFieldButton button = new VisualFieldButton(this, gameView.getFlagTexture(), gameView.getBombTexture());
