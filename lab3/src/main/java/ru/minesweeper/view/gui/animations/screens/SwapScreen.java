package ru.minesweeper.view.gui.animations.screens;
...
public class SwapScreen implements Observable {
    ...
    private JPanel currentOldScreen;
    private JPanel currentNewScreen;
    ...
    public void animateScreenSwap(JPanel oldScreen, JPanel newScreen, Sides side, JFrame frame) {
